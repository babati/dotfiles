...
let s:color_blue0 = '110'
let s:color_blue1 = '153'
let s:color_blue2 = '25'
let s:color_blue3 = '67'
...
execute('highlight! DiffAdd ctermfg='.s:color_grey4.' ctermbg='.s:color_green0.' cterm=none')
...
execute('highlight! diffAdded  ctermfg='.s:color_green0.' ctermbg='.s:nocolor.' cterm=none')
...
execute('highlight! MatchParen  ctermfg='.s:color_grey4.' ctermbg='.s:color_blue3.' cterm=none')
...
execute('highlight! Structure ctermfg='.s:color_blue3.' ctermbg='.s:nocolor.' cterm=none')
...
execute('highlight! String ctermfg='.s:color_purple2.' ctermbg='.s:nocolor.' cterm=none')
...
if get(g:, 'bgc_enable_statusline_customization', 0) == 1
    ...
    function! s:sl_change_color(mode)
        ...
        elseif a:mode == 'r'
            let current_color = s:color_blue3
        endif
